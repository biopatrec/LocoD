...
function [testLabelsPredicted,classifierModel,CC_3,CC_4,CC_5,CC_6,CC_7,numRejected,percentRejected]= ModeSpecificPostProcessing(data,Lables,Prevlabel, PostProcessing,PostProcessingThreshold,Validation,Testpercentage,trainpercentage, validationpercentage)
...
if Validation==1
    if ~isempty(lable_3)
        try
            classifierModel_3 = fitcdiscr(data_3, lable_3,'KFold',10, 'DiscrimType', 'pseudolinear');
        ...
        if PostProcessing==1  %If we want to the rejection
            ...
            numRejected=numRejected+length(testLabelsPredictedNoPP_3)-length(ZeroRemovedLabels);
        else
    ...
    if ~isempty(lable_4)
        ...
        if PostProcessing==1  %If we want to the rejection
            ...
            numRejected=numRejected+length(testLabelsPredictedNoPP_4)-length(ZeroRemovedLabels_4);
        else
    ...
    if ~isempty(lable_5)
        ...
        if PostProcessing==1  %If we want to the rejection
            ...
            numRejected=numRejected+length(testLabelsPredictedNoPP_5)-length(ZeroRemovedLabels_5);
        else
    ...
    if ~isempty(lable_6)
        ...
        if PostProcessing==1  %If we want to the rejection
            ...
            numRejected=numRejected+length(testLabelsPredictedNoPP_6)-length(ZeroRemovedLabels_6);
        else
    ...
    if ~isempty(lable_7)
        ...
        if PostProcessing==1  %If we want to the rejection
            ...
            numRejected=numRejected+length(testLabelsPredictedNoPP_7)-length(ZeroRemovedLabels_7);
        else
    ...
    percentRejected=numRejected/((length(testLabelsPredictedNoPP_7)+length(testLabelsPredictedNoPP_6)+length(testLabelsPredictedNoPP_5))...
        +length(testLabelsPredictedNoPP_4)+length(testLabelsPredictedNoPP_3));
elseif Validation==0
    if ~isempty(lable_3)
        ...
        try
            classifierModel_3= fitcdiscr(traindata_3, trainlabel_3, 'DiscrimType', dType);
            classifierModel{1}=classifierModel_3;
        catch e
            disp(e)
            errordlg(e.message);
        ...
        if PostProcessing==1  %If we want to the rejection
            ...
            numRejected=numRejected+length(testLabelsPredictedNoPP_3)-length(ZeroRemovedLabels_3);
        else
            testLabelsPredicted_3=testLabelsPredictedNoPP_3;
        end
        [C,order] =confusionmat(lable_3,testLabelsPredicted_3');
    ...
    if ~isempty(lable_4)
        ...
        try
            classifierModel_4= fitcdiscr(traindata_4, trainlabel_4, 'DiscrimType', dType);
            classifierModel{2}=classifierModel_4;
        catch e
            disp(e)
            errordlg(e.message);
    ...
    if ~isempty(lable_5)
        ...
        try
            classifierModel_5= fitcdiscr(traindata_5, trainlabel_5, 'DiscrimType', dType);
            classifierModel{3}=classifierModel_5;
        catch e
            disp(e)
            errordlg(e.message);
    ...
    if ~isempty(lable_6)
        ...
        try
            classifierModel_6= fitcdiscr(traindata_6, trainlabel_6, 'DiscrimType', dType);
            classifierModel{4}=classifierModel_6;
        catch e
            disp(e)
            errordlg(e.message);
    ...
    if ~isempty(lable_7)
        ...
        try
            classifierModel_7= fitcdiscr(traindata_7, trainlabel_7, 'DiscrimType', dType);
            classifierModel{5}=classifierModel_7;
        catch e
            disp(e)
            errordlg(e.message);
