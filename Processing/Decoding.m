...
classdef Decoding < handle
    ...
    methods
        ...
        function TreatSignal(this,recordedRawData,pressOriginal,tags)
            ...
            %% TODO: Do something with original pressure sensor signal in recordedRawData
        ...
        function OfflineClassify(this)
            ...
            if (this.ClassificationMethod== "LDA" || this.ClassificationMethod== "SVM") && this.ClassifierArchitecture=="Binary"
                %Sensor fusion
                if  this.rp.HasIMU==1 &&   this.IfProcessEMG==1 && this.IfProcessIMU ==1 &&  this.IfProcessPS==1
                    [this.features_SW_all,this.Lables_TransitionORSteady_SW_all]=SensorConcat(this.features_SW_all,this.Lables_TransitionORSteady_SW_all,this.IMUfeatures_SW_all,this.PSfeatures_SW_all);
                    [this.features_ST_all,this.Lables_TransitionORSteady_ST_all]=SensorConcat(this.features_ST_all,this.Lables_TransitionORSteady_ST_all,this.IMUfeatures_ST_all,this.PSfeatures_ST_all);
                    [this.features_SW_TR,this.Lables_SW_TR]=SensorConcat(this.features_SW_TR,this.Lables_SW_TR,this.IMUfeatures_SW_TR,this.PSfeatures_SW_TR);
                    [this.features_ST_TR,this.Lables_ST_TR]=SensorConcat(this.features_ST_TR,this.Lables_ST_TR,this.IMUfeatures_ST_TR,this.PSfeatures_ST_TR);
                    [this.features_SW_SS,this.Lables_SW_SS]=SensorConcat(this.features_SW_SS,this.Lables_SW_SS,this.IMUfeatures_SW_SS,this.PSfeatures_SW_SS);
                    [this.features_ST_SS,this.Lables_ST_SS]=SensorConcat(this.features_ST_SS,this.Lables_ST_SS,this.IMUfeatures_ST_SS,this.PSfeatures_ST_SS);
                    [this.features_all_SS,this.Lables_all_SS]=SensorConcat(this.features_all_SS,this.Lables_all_SS,this.IMUfeatures_all_SS,this.PSfeatures_all_SS);
                elseif this.rp.HasIMU==1 && this.IfProcessEMG==0 && this.IfProcessIMU ==1 &&  this.IfProcessPS==1

                    [this.features_SW_all,this.Lables_TransitionORSteady_SW_all]=SensorConcat(this.IMUfeatures_SW_all,this.IMULables_TransitionORSteady_SW_all,this.PSfeatures_SW_all);
                    [this.features_ST_all,this.Lables_TransitionORSteady_ST_all]=SensorConcat(this.IMUfeatures_ST_all,this.IMULables_TransitionORSteady_ST_all,this.PSfeatures_ST_all);
                    [this.features_SW_TR,this.Lables_SW_TR]=SensorConcat(this.IMUfeatures_SW_TR,this.IMULables_SW_TR,this.PSfeatures_SW_TR);
                    [this.features_ST_TR,this.Lables_ST_TR]=SensorConcat(this.IMUfeatures_ST_TR,this.IMULables_ST_TR,this.PSfeatures_ST_TR);
                    [this.features_SW_SS,this.Lables_SW_SS]=SensorConcat(this.IMUfeatures_SW_SS,this.IMULables_SW_SS,this.PSfeatures_SW_SS);
                    [this.features_ST_SS,this.Lables_ST_SS]=SensorConcat(this.IMUfeatures_ST_SS,this.IMULables_ST_SS,this.PSfeatures_ST_SS);
                    [this.features_all_SS,this.Lables_all_SS]=SensorConcat(this.IMUfeatures_all_SS,this.IMULables_all_SS,this.PSfeatures_all_SS);


                end

                %CLassify between transition and steady state in swing
                % [LabelsPredicted,this.ClassifierModel_TransitionSteady_SW]=OfflineClassification(this.features_SW_all,this.Lables_TransitionORSteady_SW_all,[],this.ClassificationMethod,this.ClassificationType,Testpercentage,trainpercentage, validationpercentage, this.ClassifierArchitecture, this.ClassifireValidation);
                %CLassify between transition and steady state in stance
                % [LabelsPredicted,this.ClassifierModel_TransitionSteady_ST]=OfflineClassification(this.features_ST_all,this.Lables_TransitionORSteady_ST_all,[],this.ClassificationMethod,this.ClassificationType,Testpercentage,trainpercentage, validationpercentage, this.ClassifierArchitecture, this.ClassifireValidation); %SSTR=steady or transition
                %Classify between different classes in transition Swing
                % [LabelsPredicted,this.ClassifierModel_TransitionClasses_SW]=OfflineClassification(this.features_SW_TR,this.Lables_SW_TR,[],this.ClassificationMethod,this.ClassificationType,Testpercentage,trainpercentage, validationpercentage, this.ClassifierArchitecture, this.ClassifireValidation);
                %Classify between different classes in transition Stance
                % [LabelsPredicted,this.ClassifierModel_TransitionClasses_ST]=OfflineClassification(this.features_ST_TR,this.Lables_ST_TR,[],this.ClassificationMethod,this.ClassificationType,Testpercentage,trainpercentage, validationpercentage, this.ClassifierArchitecture, this.ClassifireValidation); %TR=transition
                %Classify between different classes in Steady Swing
                [~,this.ClassifierModel,CC,~,~,~,~,~,~]=OfflineClassification(this.features_SW_SS,this.Lables_SW_SS,[],this.ClassificationMethod,this.ClassificationType,Testpercentage,trainpercentage, validationpercentage, this.ClassifierArchitecture, this.ClassifireValidation);
                %      this.ClassifierModel=[this.ClassifierModel;this.ClassifierModel_SteadyClasses_SW];
                %Classify between different classes in Steady Stance
                [~,this.ClassifierModel,CC,~,~,~,~,~,~]=OfflineClassification(this.features_ST_SS,this.Lables_ST_SS,[],this.ClassificationMethod,this.ClassificationType,Testpercentage,trainpercentage, validationpercentage, this.ClassifierArchitecture, this.ClassifireValidation); %SS=steady
                %    this.ClassifierModel=[this.ClassifierModel;this.ClassifierModel_SteadyClasses_ST];
                %Classify between different classes in Steady
                [~,this.ClassifierModel,CC,~,~,~,~,~,~]=OfflineClassification(this.features_all_SS,this.Lables_all_SS,[],this.ClassificationMethod,this.ClassificationType,Testpercentage,trainpercentage, validationpercentage, this.ClassifierArchitecture, this.ClassifireValidation);
                %    this.ClassifierModel=[this.ClassifierModel;this.ClassifierModel_SteadyClasses_all];
            elseif (this.ClassificationMethod=="LDA" || this.ClassificationMethod=="SVM" )&& this.ClassifierArchitecture=="Mode-Specific"
